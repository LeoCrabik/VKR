...
class Ui_examUnitWidget(object):
    def setupUi(self, examUnitWidget):
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=examUnitWidget)
        ...
        self.examName = QtWidgets.QLabel(parent=self.groupBox)
        ...
        self.examName.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.examName.setTextFormat(QtCore.Qt.TextFormat.AutoText)
        ...
        self.examUnit = QtWidgets.QTextEdit(parent=self.groupBox)
